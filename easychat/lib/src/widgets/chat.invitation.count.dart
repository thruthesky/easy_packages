...
/// When there are A, B, C in a group chat and A blocked B,
/// and B sent message, then the new message count should not
/// appear in the group chat room since B is blocked by A,
/// but it still appears. This is considered as
/// 'known issue' and will be fixed in the future.
