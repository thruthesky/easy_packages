    ...
    return FirebaseDatabaseQueryBuilder(
      ...
      builder: (context, snapshot, _) {
        ...
        if (snapshot.hasData && snapshot.docs.isEmpty && !snapshot.hasMore) {
          return emptyBuilder?.call() ?? const Center(child: Text('The node is empty'));
        }
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final v = snapshot.docs[index];

            return itemBuilder?.call(v, index) ??
                ListTile(
                  title: Text('$index: ${snapshot.docs[index].key}'),
                );
          },
        );
      },
